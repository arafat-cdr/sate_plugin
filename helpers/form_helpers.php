...
if(!function_exists("wl_form_heading")){
	function wl_form_heading($html_tag = false, $heading = ''){
		$use_heading = '';

		esc_html( $html_tag );

		if( $html_tag ){
			$use_heading .= "<$html_tag style='color:black !important;'>".$heading."</$html_tag>";
		}
		return $use_heading;
	}
}
...
if( !function_exists("web_lover_form_select") ){

	function web_lover_form_select( $name, $options = array(), $value = '', $is_required = '', $is_label_name = '', $is_place_holder = '' ){
	    ...
	    $input .=  "<label $label_for><strong>$label_name<strong></label> <br/>\n";
	    $input .= "<select $name_field $required tabindex='1' class='single_select_2'>\n";
